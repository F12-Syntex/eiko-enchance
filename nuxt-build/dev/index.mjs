...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/ufo/dist/index.mjs';
import { hash } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/src/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\git-repo\\EikoEnhance\\electron-nuxt3\\eiko-enchance","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\git-repo\\EikoEnhance\\electron-nuxt3\\eiko-enchance\\src\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\git-repo\\EikoEnhance\\electron-nuxt3\\eiko-enchance\\nuxt-build","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\git-repo\\EikoEnhance\\electron-nuxt3\\eiko-enchance\\nuxt-build\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\git-repo\\EikoEnhance\\electron-nuxt3\\eiko-enchance\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _6LTQMX3Udc = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance";
...
const _h3GpkWekAV = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const getClientManifest = () => import('file://D:/git-repo/EikoEnhance/electron-nuxt3/eiko-enchance/nuxt-build/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
